"""
This is the first version of the translation app from the book "Tkinter by Example" by David Love, Jan 2018
Tkinter by Example, Chapter 3, App 1
...
class TranslateBook(tk.Tk):
    def __init__(self):
        ...
        self.italian_copy_button = tk.Button(italian_tab, text="Copy to Clipboard",
        ...
        self.italian_label = tk.Label(italian_tab, textvar=self.italian_translation,
